...
echo sprintf(
    '   • Contact point  : %s %s %s',
    $lodging->getContactPoint()->getAddress()->getStreet(),
    $lodging->getContactPoint()->getAddress()->getHouseNumber(),
    $lodging->getContactPoint()->getAddress()->getBusNumber()
), PHP_EOL;
echo sprintf(
    '                      %s %s',
    $lodging->getContactPoint()->getAddress()->getPostalCode(),
    $lodging->getContactPoint()->getAddress()->getLocality()
), PHP_EOL;
echo sprintf(
    '                      t %s',
